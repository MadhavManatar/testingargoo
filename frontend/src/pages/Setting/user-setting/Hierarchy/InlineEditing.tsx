...
const InlineEditable = (props: EditableProps) => {
  const {
    children,
    editComponent,
    onCancel,
  ...
  return isEditing && !disabled ? (
    ...
    >
      ...
      <div className="inlineEdit__action static flex items-center justify-end w-full pt-[7px]">
        <button
          className='cancelBtn w-[30px] h-[30px] rounded-[6px] bg-btnGrayColor text-[0px] relative shadow-[1px_1px_2px_#a4a4a4] duration-500 before:content-[""] before:absolute before:top-[50%] before:left-[50%] before:translate-x-[-50%] before:translate-y-[-50%] before:rotate-45 before:w-[14px] before:h-[2px] before:bg-sdBlack__bg before:duration-500 after:content-[""] after:absolute after:top-[50%] after:left-[50%] after:translate-x-[-50%] after:translate-y-[-50%] after:-rotate-45 after:w-[14px] after:h-[2px] after:bg-sdBlack__bg after:duration-500 hover:bg-sdBlack__bg hover:before:bg-sdWhite__bg hover:after:bg-sdWhite__bg'
          onClick={(e) => {
        ...
        <Button
          className={`submitBtn flex items-center justify-center ml-[5px] w-[30px] h-[30px] !p-0 rounded-[6px] bg-primaryColorSD text-[0px] relative shadow-[1px_1px_2px_#a4a4a4] before:content-[""] before:absolute before:top-[9px] before:left-[9px] before:w-[13px] before:h-[8px] duration-500 before:border-l-[2px] before:border-l-[#ffffff] before:border-b-[2px] before:border-b-[#ffffff] before:-rotate-45 hover:bg-primaryColorSD ${
