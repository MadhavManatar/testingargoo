...
const RegionBlock = (props: Props) => {
  ...
  const {
    ...
    watch,
    setValue,
  } = useForm<AddRegionFormFieldType>({
  ...
  const onSave = (key: keyof AddRegionFormFieldType) => {
      ...
      >
        <div className="header__details !bg-[#FDE6CF]">
          <InlineEditable
            ...
            onSave={onSave('title')}
            editComponent={
              <FormField<AddRegionFormFieldType>
                type="text"
                name="title"
