...
const BranchBlock = (props: Props) => {
  ...
  const {
    ...
    watch,
    setValue,
  } = useForm<AddBranchFormFieldType>({
  ...
  const onSave = (key: keyof AddBranchFormFieldType) => {
  ...
  return (
    <>
      ...
      >
        <div className="header__details !bg-[#D3F2E0]">
          <InlineEditable
            ...
            onSave={onSave('title')}
            editComponent={
              <FormField<AddBranchFormFieldType>
                type="text"
                name="title"
        ...
        <div className="body__wrapper relative">
          ...
          <div className="time__wrapper">
            <Icon iconType="clockStrokeIcon" />
            <span className="text">Central Standard Time (CST)</span>
          </div>
          <div className="location__wrapper">
            <Icon iconType="locationStrokeIcon" />
            <span className="text">Florida, USA</span>
          </div>
