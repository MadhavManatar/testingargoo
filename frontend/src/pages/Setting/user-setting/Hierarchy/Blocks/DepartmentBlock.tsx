...
type AddDepartmentFormFieldType = {
  title: string;
  description: string;
...
const DepartmentBlock = (props: Props) => {
  ...
  const {
    ...
    watch,
    setValue,
  } = useForm<AddDepartmentFormFieldType>({
  ...
  const onSave = (key: keyof AddDepartmentFormFieldType) => {
      ...
      >
        <div className="header__details !bg-[#F7CED5]">
          <InlineEditable
            ...
            onSave={onSave('title')}
            editComponent={
              <FormField<AddDepartmentFormFieldType>
                type="text"
                name="title"
