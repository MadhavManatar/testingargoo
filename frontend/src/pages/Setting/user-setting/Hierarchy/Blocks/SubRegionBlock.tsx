...
type AddSubRegionFormFieldType = {
  title: string;
  description: string;
...
const SubRegionBlock = (props: Props) => {
  ...
  const {
    ...
    watch,
    setValue,
  } = useForm<AddSubRegionFormFieldType>({
  ...
  const onSave = (key: keyof AddSubRegionFormFieldType) => {
  ...
  const insertNodeOptions = [
    {
      title: LEVEL_TITLE.ADD_SUB_REGION,
      type: LEVEL_TYPES.REGION,
      permission: true,
    },
    {
      title: LEVEL_TITLE.ADD_BRANCH,
      type: LEVEL_TYPES.BRANCH,
      permission: true,
    },
    {
      title: LEVEL_TITLE.ADD_DEPARTMENT,
      type: LEVEL_TYPES.DEPARTMENT,
      permission: true,
    },
    { title: LEVEL_TITLE.ADD_TEAM, type: LEVEL_TYPES.TEAM, permission: true },
    {
  ...
  return (
    <>
      ...
      >
        <div className="header__details !bg-[#FDE6CF]">
          <InlineEditable
            ...
            onSave={onSave('title')}
            editComponent={
              <FormField<AddSubRegionFormFieldType>
                type="text"
                name="title"
