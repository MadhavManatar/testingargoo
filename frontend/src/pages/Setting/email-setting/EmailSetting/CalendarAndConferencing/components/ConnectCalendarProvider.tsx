...
const ConnectCalendarProvider = () => {
  ...
  return (
    <>
      <div className="calendar__conferencing__box p-[25px] pb-0 mb-[25px] bg-gray__BGColor rounded-[12px] lg:p-[17px] lg:pb-[3px] sm:bg-transparent sm:border sm:border-[#CCCCCC]/50 sm:rounded-[12px] sm:mb-[15px]">
...
export default ConnectCalendarProvider;
